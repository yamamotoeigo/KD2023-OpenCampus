...
class Detector_yolov8l():
    ...
    def detector(self, image):
        ...
        results = self.model(image, save=False, conf=0.5, iou=0.4, classes=0, device=[0,1,2])
        ...
        image = self.draw_edge(image=results_detected, band_width=20, color=[255,0,161])
