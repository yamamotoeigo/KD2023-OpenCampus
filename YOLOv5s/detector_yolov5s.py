...
class Detector_yolov5s():
    ...
    def detector(self, img):
        ...
        results = self.model(img, save=False, conf=0.5, iou=0.4, classes=0, device=[0,1,2])
        ...
        image = self.draw_edge(image=results_detected, band_width=20, color=[0,217,255])
